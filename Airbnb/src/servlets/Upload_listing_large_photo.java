...
/**
 * Servlet implementation class Upload_listing_large_photo
 */
@WebServlet("/Upload_listing_large_photo")
public class Upload_listing_large_photo extends HttpServlet {
     ...
     */
    public Upload_listing_large_photo() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String path = UPLOAD_DIRECTORY + File.separator + user.getUser_id() + File.separator + "listing_images" + File.separator + listing.getListing_id() + File.separator + "listing_large_image";
