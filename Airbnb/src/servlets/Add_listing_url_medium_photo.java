...
/**
 * Servlet implementation class Add_listing_url_medium_photo
 */
@WebServlet("/Add_listing_url_medium_photo")
public class Add_listing_url_medium_photo extends HttpServlet {
     ...
     */
    public Add_listing_url_medium_photo() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String old_photo_abs_path = UPLOAD_DIRECTORY + File.separator + user.getUser_id() + File.separator + "listing_images" + File.separator + listing.getListing_id()  + File.separator + "listing_medium_image" + File.separator + old_photo_name;
		...
		listing.setPhoto_medium(request.getParameter("Photo"));
